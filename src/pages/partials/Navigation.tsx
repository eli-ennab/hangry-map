					...
					<Nav className="ms-auto align-middle">
						{currentUser || user?.admin ? (
							...
							<>
								<Nav.Link as={NavLink} title={'The Map!'} to="/map"><span className="material-symbols-outlined align-middle">map</span> Map</Nav.Link>
								<Nav.Link as={NavLink} title={'List All Places!'} to="/places"><span className="material-symbols-outlined align-middle">where_to_vote</span> Places</Nav.Link>
								<Nav.Link as={NavLink} title={'Sing Up Now!'} to="/signup"><span className="material-symbols-outlined align-middle">person_add</span> Sign Up</Nav.Link>
								<Nav.Link as={NavLink} title={'Log In'} to="/login"><span className="material-symbols-outlined align-middle">login</span> Log In</Nav.Link>
							</>
						)}
					</Nav>
				</Navbar.Collapse>
