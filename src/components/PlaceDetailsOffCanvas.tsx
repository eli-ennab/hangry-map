			...
			<Offcanvas.Body>
				{selectedPlace && (
					<>
						...
						<p><strong>Directions:</strong>{' '}<a href={selectedPlace.gMapsLink} target={_blank}> 
						...
						{selectedPlace.website && (
							<p><strong>Website:</strong>
								<a href={selectedPlace.website} className="text-decoration-none">{selectedPlace.website}</a>
							</p>
						)}
						{selectedPlace.facebook && (
							<p><strong>Facebook:</strong>
								<a href={selectedPlace.facebook} className="text-decoration-none">{selectedPlace.facebook}</a>
							</p>
						)}
						{selectedPlace.instagram && (
							<p><strong>Instagram:</strong>
								<a href={selectedPlace.instagram} className="text-decoration-none">{selectedPlace.instagram}</a>
							</p>
						)}
